...
void Aceleraciones(uint np,ushort n_esp_p,uint *M_int,uint *esp_p,uint3 *mad_de_p,double &pot,double *M_param,double *pos,double *acel,double3 caja,bool nconf,potencial pote)
{
    pot=0.;
    uint mol1,mol2;
    double2 fuerza;
...
void SimulacionNOpt(float ncp,ushort n_esp_p,ushort n_esp_m,uint nc,uint np,uint max_p_en_esp_mr,uint GdL,uint *M_int, uint *esp_p,uint *n_p_esp_m,uint *n_m_esp_mr,uint *p_en_m,uint3 *mad_de_p,double dens,double dt,double temp_d,double p_termo,double *masa,
                    double *q_rat,double *pos,double *vel,double *acel,double *constr,double *param,double *dis_p_esp_mr_rep,double3 caja,ensamble ens,algoconstr vibrante,termostatos termo,potencial pot,std::ofstream &ofasres,std::ofstream &ofasat,std::ofstream &ofaeva)
{
    ...
    Aceleraciones(np,n_esp_p,M_int,esp_p,mad_de_p,epi,M_param,pos,acel,caja,nconf,pot);
